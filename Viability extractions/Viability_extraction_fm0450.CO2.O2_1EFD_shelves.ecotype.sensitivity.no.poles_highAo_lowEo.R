...
A0.xxx <- rlnorm(init.ecotypes, meanlog = u_A_high, sdlog = sig_A_half)

# sample Eo values from PDF (normal distribution)
E0.xxx <- rnorm(init.ecotypes, mean = u_E_low, sd = sig_E_half)
...
save(ecotypes.summary, file=paste0(rdata.directory,config.short,".CO2.O2.", EFD, "EFD ecotypes summary ", ocean.mask, ".ecotype.sensitivity.no.poles_highAo_lowEo.Rdata"))
save(ecotypes.summary.short, file=paste0(rdata.directory,config.short,".CO2.O2.", EFD, "EFD ecotypes summary ", ocean.mask, " short.ecotype.sensitivity.no.poles_highAo_lowEo.Rdata"))
