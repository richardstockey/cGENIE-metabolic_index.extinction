...
ecotypes.summary <-  data.frame(ecotype=double(), cells = double(), O2.pal=double(), CO2.pal=double())
ecotypes.summary.short <-  data.frame(ecotypes.number = double(), O2.pal=double(), CO2.pal=double(), eq.temp=double())
...
save(ecotypes.summary, file=paste0(rdata.directory,config.short,".CO2.O2.", EFD, "EFD ecotypes summary ", ocean.mask, ".no.poles.Rdata"))
save(ecotypes.summary.short, file=paste0(rdata.directory,config.short,".CO2.O2.", EFD, "EFD ecotypes summary ", ocean.mask, " short.no.poles.Rdata"))
