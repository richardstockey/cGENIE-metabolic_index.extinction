...
save(ecotypes.summary, file=paste0(rdata.directory,config.short,".CO2.O2.", EFD, "EFD ecotypes summary ", ocean.mask, ".ecotype.sensitivity.no.poles_highAo_highEo.Rdata"))
save(ecotypes.summary.short, file=paste0(rdata.directory,config.short,".CO2.O2.", EFD, "EFD ecotypes summary ", ocean.mask, " short.ecotype.sensitivity.no.poles_highAo_highEo.Rdata"))
